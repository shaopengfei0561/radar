...
CRadarUIDlg::CRadarUIDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CRadarUIDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CRadarUIDlg, CDialog)
...
void CRadarUIDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CRadarUIDlg::OnButton1() 
{
	// TODO: Add your control notification handler code here
	//CPeizDlg dlg;
	//dlg.DoModal();
	CPeizDlg* dlg = new CPeizDlg();
	dlg->Create(IDD_PEIZHI);
}

void CRadarUIDlg::OnButton3() 
{
	// TODO: Add your control notification handler code here
		CChakDlg dlg;
	   dlg.DoModal();
...
void CRadarUIDlg::OnCannal() 
{
	// TODO: Add your control notification handler code here
      CRadarUIDlg::OnCancel();
