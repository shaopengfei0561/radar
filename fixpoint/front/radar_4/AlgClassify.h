...
namespace alg_classify
{
	...
	{
		float lidar1angle[20];
		float lidar2angle[20];
		int coorshift[20];
	}CoordiShift; 
	...
	public:
		...
		long int m_Num;
		SYSPOINT m_Vpoint[6000000];				//点云点集
		...
		*/
		int GetResult(int lidar1Data[2000][529], int lidar2Data[2000][529], int lidar3Data[2000][529], int lidar4Data[2000][529]);
